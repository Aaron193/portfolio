...
const carousels: CarouselConfig[] = [
    {
        ...
        direction: 'ltr',
        items: [
            { name: 'Go' , icon: 'logos:go', desc: 'Statically typed compiled language for systems programming' },
    ...
    },
    {
        ...
        direction: 'rtl',
        items: [
            { name: 'Kubernetes', icon: 'logos:kubernetes', desc: 'Container orchestration platform' },
            { name: 'Docker', icon: 'logos:docker-icon', desc: 'Containerization platform' },
            { name: 'AWS', icon: 'logos:aws', desc: 'Cloud computing services' },
            { name: 'OpenShift', icon: 'logos:openshift', desc: 'Enterprise Kubernetes platform' },
            { name: 'ArgoCD', icon: 'devicon:argocd', desc: 'Declarative GitOps continuous delivery tool' },
            ...
            { name: 'PostgreSQL', icon: 'logos:postgresql', desc: 'Powerful open-source relational database' },
        ],
    },
    {
        key: 'tools',
